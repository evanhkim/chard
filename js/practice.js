...
$(document).ready(function() {
	$.ajax({
		...
		success:function(result) {
            ...
            $("#termCount").text(terms[quizIndex]);
            
            alert(defs[quizIndex].length);
		}
    });
...
$('#submit').on('click', function() {
    ...
    var compositeOperation = context.globalCompositeOperation;
        ...
        var backgroundColor = canvas.getAttribute("data-color");
    ...
    $.ajax({
        ...
        success:function(result) {
            ...
            if (result == 'yes') {
                ...
                wrong('practice','Wrong! '+terms[quizIndex]+' means '+defs[quizIndex]);
            }
            //reset page
            $(this).toggleClass('running');
	        $('.update').fadeOut(1);
